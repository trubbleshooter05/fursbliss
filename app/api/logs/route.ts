...
const logSchema = z.object({
  ...
  appetiteLevel: z.number().min(1).max(10).optional(),
  mobilityLevel: z.number().min(1).max(10).optional(),
  ...
  try {
    ...
    const log = await prisma.healthLog.create({
      data: {
        ...
        appetiteLevel: parsed.data.appetiteLevel ?? null,
        mobilityLevel: parsed.data.mobilityLevel ?? null,
